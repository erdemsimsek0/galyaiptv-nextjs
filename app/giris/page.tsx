        ...
        <div className="rounded-2xl border border-[#1e2d42] bg-[#0a1525]/80 p-8 backdrop-blur-sm shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label className="text-xs font-semibold text-[#8b9ab3]">Şifre</label>
                <Link href="/sifre-unuttum" className="text-xs font-medium text-[#3b82f6] transition-colors hover:text-[#60a5fa]">
                  Şifremi unuttum
                </Link>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-white py-3.5 text-sm font-bold text-[#111] transition-all hover:bg-gray-100 active:scale-[0.98] disabled:opacity-60"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex-1 h-px bg-[#1e2d42]" />
              <span className="text-[11px] font-semibold uppercase tracking-wider text-[#374151]">Hesabınız yok mu?</span>
              <div className="flex-1 h-px bg-[#1e2d42]" />
            </div>
            <Link
              href="/kayit"
